...
public class OfflineSlip extends HttpServlet {
...
public void doPost(HttpServletRequest req,HttpServletResponse res) throws IOException, ServletException
{
   ...
   PrintWriter pw= res.getWriter();
    ...
    try {
        ps = cn.c.prepareStatement("INSERT INTO offlineslip (s_id, id, name, age, gender, date, type, doctor,fathername,mobileno,street,city,state,patienttype) VALUES (?,?,?,?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)");
        ...
        int i = ps.executeUpdate();
				...
				if(i>0)
				{
					 ...
					 res.sendRedirect("Slips/Slip.jsp?s_id=" + s_id);
