...
String s = "SELECT * FROM doctortable WHERE id =  '"+id+"'  ";
...
if (rs.next()) {
 ...
 <div class="container">
 <header1>Doctor Update Details</header1>
   ...
   <form action="../UpdateDoctor" method="post">
         ...
         <div class="form first">
            ...
            <div class="input-field">
                <label>Age</label>
                <input type="text"name ="age"value="<%= rs.getString(3)%>"required>
            </div>
            <div class="input-field">  
        ...
        <input type="text"name ="gender"value="<%= rs.getString(4)%>"required>
			 ...
			 <div class="input-field">
                ...
                <input type="text" name="qualification"value="<%= rs.getString(5) %>"required>
            </div> 
              <div class="input-field">
                <label>Specialist</label>
                <input type="text" name="specialist"value="<%= rs.getString(6) %>">
            </div>
           ...
           <div class="details personal">
            ...
            <input type="text"placeholder="enter your id no"name="idno"id="idno"value="<%= rs.getString(15) %>">
...
<% } else { %>
        <p>No Doctor data found for the provided ID.</p>
    <% } %>
    </body>
</html>
