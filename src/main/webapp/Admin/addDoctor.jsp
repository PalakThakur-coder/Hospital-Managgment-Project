...
<body>
	...
	ps = cn.c.prepareStatement("select MAX(id)from Doctortable");
	rs = ps.executeQuery();
	while (rs.next()) {
	...
	<div class="container">
		...
		<form action="../AddDoctor" method="post">
			...
			<div class="form first">
                ...
                <label class="required-field">Doctor ID</label>
			 ...
			 <div class="input-field">
                ...
                <div class="input-field">
                <label class="required-field">Specialist</label>
