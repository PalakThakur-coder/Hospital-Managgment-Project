...
String s = "SELECT * FROM recptable WHERE id =  '"+id+"'  ";
...
if (rs.next()) {
 ...
 <header1>Doctor Update Details</header1>
   ...
   <form action="../UpdateRecp" method="post">
        ...
        <input type="text"name ="gender"value="<%= rs.getString(4)%>"required>
			 ...
			 <div class="input-field">
              ...
              <div class="input-field">
                ...
                <input type="text" name="responsibility"value="<%= rs.getString(6) %>">
            </div>
...
<% } else { %>
        <p>No Representative data found for the provided ID.</p>
    <% } %>
    </body>
</html>
