...
<div class= "serchbar">
<h2>Representator Search</h2>
    
         <form action="ListRecp.jsp">
          <div class="fields">
      ...
      <h3>or</h3>
        <a href="ListRecp.jsp" class="show-all-button">Reset</a>
  ...
  if (searchType != null && searchTerm != null) {
       ...
       if ("id".equals(searchType)) {
          query = "SELECT * FROM recptable WHERE id = ?";
          
      } else if ("name".equals(searchType)) {
          query = "SELECT * FROM recptable WHERE name LIKE ?";
      } else if ("email".equals(searchType)) {
          query = "SELECT * FROM recptable WHERE email = ?";
      } else if ("mobileno".equals(searchType)) {
          query = "SELECT * FROM recptable WHERE mobileno = ?";
      }else{
    	  out.println("data not match");
      }
  }
  else {
    	 query1= "Select * from Recptable";
  ...
  ResultSet rs = ps.executeQuery();
      ...
      while (rs.next()) {
        ...
        <tr >
         ...
         <td>  <a href="UpdateRecp.jsp?id=<%= id %>">Update</a>
