...
<body>
	...
	<div class="serchbar">
		...
		<form action="CreateSlip.jsp">
			<div class="fields">
				...
				<br> <label for="searchTerm">Search Term:</label> <input
					type="text" name="searchTerm" class="searchTerm" id="searchTerm">

				<input type="submit" value="Search">
				<h3>or</h3>
				<a href="CreateSlip.jsp" class="show-all-button">Reset</a>
	...
	<table border='1'>
		...
		<tr>
			...
			<td><a href="CreateSlip2.jsp?id=<%=id%>"> OPD</a>
			<td><a href="IpdSlipCreate.jsp?id=<%=id%>"> IPD</a>
		</tr>
