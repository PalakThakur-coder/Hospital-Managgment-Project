...
<h2> Edit Patient </h2>
         ...
         <form action="UpdatePatientList.jsp">
          <div class="fields">
      ...
      <h3>or</h3>
        <a href="UpdatePatientList.jsp" class="show-all-button">Reset</a>
  ...
  if (searchType != null && searchTerm != null) {
       ...
       if ("id".equals(searchType)) {
    	 ...
    	 query1= "Select * from patienttable";
  ...
  ResultSet rs = ps.executeQuery();
      ...
      while (rs.next()) {
        ...
        <tr >
         ...
         <td>  <a href="UpdatePatient.jsp?id=<%= id %>">Edit</a>
