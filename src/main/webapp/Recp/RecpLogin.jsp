...
<html>
  ...
  overflow: hidden;
    ...
    <body>
        ...
        <!-- Sing in  Form -->
        <form action="../RecpLogin" method="post">
                ...
                <div class="container">
                    <div class="signin-content">
                        ...
                        <div class="signin-form">
                            <h2 class="form-title"> Executive Sign in</h2>
                           
                                <div class="form-group">
                                    <label for="your_name"><i class="zmdi zmdi-account material-icons-name"></i></label>
                                    <input type="text" name="username" id="your_name" placeholder="User Name"required/>
                                </div>
                                <div class="form-group">
                                 ...
                                 <div>
                               <a href="RecpNewPass.jsp" class="signup-image-link">Forgot password ?</a>
                               </div>
